...
export async function seedCraftsIfEmpty(): Promise<Craft[]> {
  ...
  const defaults = [
    ...
    { name: "LSAT Prep", tag: "next.js · redis · adaptive", desc: "Adaptive LSAT practice. Daily editions, weighted drills, skill spotter, streak runs, timed speed sets, and a marathon mode. Tracks weak areas and adjusts.", href: "https://lsat.grannis.xyz" },
    { name: "Federal Courts", tag: "next.js · redis · doctrine", desc: "A drilling-ground for the doctrines that decide who decides. Standing, justiciability, jurisdiction — with adaptive drills, prong sorting, case matching, and a daily hypothetical.", href: "https://fedcourts.grannis.xyz" },
    { name: "Rose Window", tag: "next.js · vercel · game", desc: "A puzzle game inspired by Gothic cathedral rose windows.", href: "https://rosewindow.grannis.xyz" },
